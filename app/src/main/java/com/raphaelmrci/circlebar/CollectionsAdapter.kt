...
class CollectionsAdapter(private val mCollections : MutableMap<String, MutableList<Cocktail>>) : RecyclerView.Adapter<CollectionsAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val collectionTitle: TextView = itemView.findViewById<TextView>(R.id.collectionTitle)
        val cocktailsRecycler = itemView.findViewById<RecyclerView>(R.id.cocktailsList)
    }
